...
function About() {
  return (
    <div className="grid grid-cols-2 pt-40 w-full py-14 max-w-screen-xl mx-auto">
    <div className="h-100 w-100 bg-no-repeat bg-cover text-left px-20">
    ...
    <div className="h-100 w-100 flex-col px-20">
